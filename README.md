...
2. Installez les dépendances requises en utilisant pip dans votre environement.
...
3. Depuis la racine du projet, exécutez le fichier principal.
    ```bash
    python3 main.py -n <nombre_d_iterations> -m <type_de_modele> -v <niveau_de_verbosité>
    ```
